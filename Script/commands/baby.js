...
module.exports.handleEvent = async function ({ api, event, Users }) {
 ...
 if (
 raw === "baby" || raw === "bot" || raw === "bal" ||
 raw === "jan" || raw === "kire" || raw === "জান" || raw === "বট" || raw === "বেবি" 
 ) {
 const greetings = [
        "বেশি bot Bot করলে leave নিবো কিন্তু😒😒",
        "শুনবো না😼 তুমি আমার বস HASAN কে প্রেম করাই দাও নাই🥺পচা তুমি🥺",
        "আমি আবাল দের সাথে কথা বলি না,ok😒",
        "এতো ডেকো না,প্রেম এ পরে যাবো তো🙈",
        "Bolo Babu, তুমি কি আমার বস HASAN কে ভালোবাসো? 🙈💋",
        ...
        "আমাকে না ডেকে মেয়ে হলে বস HASAN ইনবক্সে চলে যা 🌚😂 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐋𝐢𝐧𝐤 : https://www.facebook.com/100060413954663",
        ...
        "আমাকে ডেকো না,আমি বস সাথে ব্যাস্ত আছি",
        "কি হলো , মিস্টেক করচ্ছিস নাকি🤣",
        "বলো কি বলবা, সবার সামনে বলবা নাকি?🤭🤏",
        "জান মেয়ে হলে বস এর ইনবক্সে চলে যাও 😍🫣💕 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐋𝐢𝐧𝐤 : https://www.facebook.com/100060413954663",
        ...
        "ভালোবাসার নামক আবলামি করতে চাইলে বস এর ইনবক্সে গুতা দিন ~🙊😘🤣 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐋𝐢𝐧𝐤 : https://www.facebook.com/100060413954663",
        ...
        "জান তোমার বান্ধবী রে আমার বস  হাতে তুলে দিবা-🙊🙆‍♂",
        ...
        "আমার বস এর পক্ষ থেকে তোমারে এতো এতো ভালোবাসা-🥰😽🫶 আমার বস 𝐇𝐀𝐒𝐀𝐍 6𝐓9 ইসলামে'র জন্য দোয়া করবেন-💝💚🌺🌻",
        "- ভালোবাসা নামক আব্লামি করতে মন চাইলে আমার বস এর ইনবক্স চলে যাও-🙊🥱👅 🌻𝐅𝐀𝐂𝐄𝐁𝐎𝐎𝐊 𝐈𝐃 𝐋𝐈𝐍𝐊 🌻:- https://www.facebook.com/100060413954663",
        "আমার জান তুমি শুধু আমার আমি তোমারে ৩৬৫ দিন ভালোবাসি-💝🌺😽",
        "কিরে প্রেম করবি তাহলে বস এর ইনবক্সে গুতা দে 😘🤌 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐋𝐢𝐧𝐤 : https://www.facebook.com/100060413954663",
        ...
        "প্রেম করতে চাইলে বস ইনবক্সে চলে যা 😏🐸 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐋𝐢𝐧𝐤 : https://www.facebook.com/100060413954663",
        "-আজ একটা বিন নেই বলে ফেসবুকের নাগিন-🤧-গুলোরে আমার বস এর ধরতে পারছে না-🐸🥲",
        ...
        "সুন্দর মাইয়া মানেই-🥱আমার বস এর' বউ-😽🫶আর বাকি গুলো আমার বেয়াইন-🙈🐸🤗",
        ...
        "মেয়ে হলে বস এর ইনবক্সে চলে যা 🤭🤣😼 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐋𝐢𝐧𝐤 : https://www.facebook.com/100060413954663",
        ...
        "-ওই বেডি তোমার বাসায় না আমার বস এর মেয়ে দেখতে গেছিলো-🙃-নাস্তা আনারস আর দুধ দিছো-🙄🤦‍♂️-বইন কইলেই তো হয় বয়ফ্রেন্ড আছে-🥺🤦‍♂-আমার বস 𝐇𝐀𝐒𝐀𝐍 6𝐓9 কে জানে মারার কি দরকার-🙄🤧",
 ...
 if (
 raw.startsWith("baby ") || raw.startsWith("bot ") || raw.startsWith("bal ") ||
 raw.startsWith("jan ") || raw.startsWith("kire ") ||
 raw.startsWith("জান ") || raw.startsWith("বট ") || raw.startsWith("বেবি ")
 ) {
 const query = raw
 .replace(/^baby\s+|^bot\s+|^bal\s+|^jan\s+|^kire\s+|^জান\s+|^বট\s+|^বেবি\s+/i, "")
 .trim();
 if (!query) return;
